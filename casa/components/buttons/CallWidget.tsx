...
const CallWidget = ({ t }: { t: TFunction }) => {
    ...
    return (
        <div className="relative">
            <button className="p-3 md:p-4 bg-neutral-100 rounded-[100%] after:inline-block after:w-full after:h-full after:absolute 
            after:duration-[400] after:transition-all after:inset-0 after:z-[-1] transition-all duration-[400] shadow-bold
            after:rounded-[100%] after:bg-neutral-100 [&:hover]:after:scale-[1.4] [&:hover]:after:opacity-0 relative z-10 border border-neutral-900" 
            >
                <a target="_blank" href="https://zalo.me/0373522843"  className="aspect-square mx-auto" onMouseEnter={() => setCallNumberVisible(true)} ref={buttonRef}>
                ...
                {callNumberVisible && (
                    ...
                    flex gap-2 md:gap-4 flex-col cursor-default z-20 border border-neutral-400" ref={numbersRef}>
                        <h4 className="text-neutral-800 font-medium -md:text-xs">{t('callNow')}</h4>
